<template>
  <div
    class="bg-surface-0 dark:bg-surface-950 px-6 py-12 md:px-12 lg:px-20 text-center flex flex-col items-center"
  >
    <svg
      width="50"
      height="50"
    ...
    <div class="font-medium text-surface-900 dark:text-surface-0 mt-6 mb-4">
      &copy; 2023 Bastion, Inc
    </div>
    <p class="text-surface-600 dark:text-surface-200 leading-normal mt-0 mb-6">
    ...
    <div class="flex items-center justify-center">
      <a
        class="cursor-pointer text-surface-700 dark:text-surface-100 mr-8 hover:opacity-75"
      >
      ...
      <a
        class="cursor-pointer text-surface-700 dark:text-surface-100 hover:opacity-75"
      >
